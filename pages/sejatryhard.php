...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" href="styles/sejatryhard.css">
  </head>
  <body>
    <header>
    ...
    <main>
        <section>
            <div class="d-flex justify-content-around pt-2 border-bottom border-dark ">
                <p class="btn btn-danger">LOL</p>
                <p class="btn btn-danger">TfT</p>
                <p class="btn btn-danger">CS GO</p>
                <p class="btn btn-danger">VALORANT</p>
            </div>
        </section>
